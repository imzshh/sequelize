...
module.exports = (function() {
  var QueryGenerator = {
    ...
    pgSqlDate: function (dt) {
      var date = [ dt.getFullYear(), QueryGenerator.padInt(dt.getMonth()+1), QueryGenerator.padInt(dt.getDate()) ].join('-')
      var time = [ dt.getHours(), QueryGenerator.padInt(dt.getMinutes()), QueryGenerator.padInt(dt.getSeconds())].join(':')
